(function(){const v=document.createElement("link").relList;if(v&&v.supports&&v.supports("modulepreload"))return;for(const S of document.querySelectorAll('link[rel="modulepreload"]'))_(S);new MutationObserver(S=>{for(const N of S)if(N.type==="childList")for(const H of N.addedNodes)H.tagName==="LINK"&&H.rel==="modulepreload"&&_(H)}).observe(document,{childList:!0,subtree:!0});function f(S){const N={};return S.integrity&&(N.integrity=S.integrity),S.referrerPolicy&&(N.referrerPolicy=S.referrerPolicy),S.crossOrigin==="use-credentials"?N.credentials="include":S.crossOrigin==="anonymous"?N.credentials="omit":N.credentials="same-origin",N}function _(S){if(S.ep)return;S.ep=!0;const N=f(S);fetch(S.href,N)}})();function Wu(g){return g&&g.__esModule&&Object.prototype.hasOwnProperty.call(g,"default")?g.default:g}var Tl={exports:{}},xr={},Pl={exports:{}},te={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ru;function Wf(){if(Ru)return xr;Ru=1;var g=Fl(),v=Symbol.for("react.element"),f=Symbol.for("react.fragment"),_=Object.prototype.hasOwnProperty,S=g.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,N={key:!0,ref:!0,__self:!0,__source:!0};function H(P,C,L){var B,I={},W=null,q=null;L!==void 0&&(W=""+L),C.key!==void 0&&(W=""+C.key),C.ref!==void 0&&(q=C.ref);for(B in C)_.call(C,B)&&!N.hasOwnProperty(B)&&(I[B]=C[B]);if(P&&P.defaultProps)for(B in C=P.defaultProps,C)I[B]===void 0&&(I[B]=C[B]);return{$$typeof:v,type:P,key:W,ref:q,props:I,_owner:S.current}}return xr.Fragment=f,xr.jsx=H,xr.jsxs=H,xr}var Lu;function Hf(){return Lu||(Lu=1,Tl.exports=Wf()),Tl.exports}var s=Hf(),J=Fl();const Vf=Wu(J);var _i={},zl={exports:{}},Xe={},Ml={exports:{}},_l={};/**
 * @license React
...
`;Xf.createRoot(document.getElementById("root")).render(s.jsx(Vf.StrictMode,{children:s.jsx(ed,{})}));
